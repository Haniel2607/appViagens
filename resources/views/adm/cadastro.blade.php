                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <body>
                        <div class="form-container"
                            style="width: 800px; padding: 20px; background-color: white; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="fotoDescricao" accept="image/*"
                                        required>
                                </div>
